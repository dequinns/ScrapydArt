...
class Config(object):
    ...
    def _getsources(self):
        sources = ['/etc/scrapydart/scrapydart.conf', r'c:\scrapyd\scrapyd.conf']
        sources += sorted(glob.glob('/etc/scrapydart/conf.d/*'))
        sources += ['scrapydart.conf']
        sources += [expanduser('~/.scrapydart.conf')]
